...
public class Ex26DDayEx extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ex26_dday);
        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View a_view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Ex26DDayEx.this, mDateSetListener, year, month, day);
                dialog.show();
            }
        };
    ...
    private String getToday() {
        ...
        final String strFormat = "yyyy년 MM월 dd일 E요일";
